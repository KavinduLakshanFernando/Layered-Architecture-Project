...
public class ItemDaoImpl implements ItemDao {
    ...
    public void SaveItem(ItemDTO Idto) throws SQLException, ClassNotFoundException {
        ...
        pstm.setString(1, Idto.getCode());
        pstm.setString(2, Idto.getDescription());
        pstm.setBigDecimal(3,Idto.getUnitPrice());
        pstm.setInt(4,Idto.getQtyOnHand());
        pstm.executeUpdate();
    }
    ...
    public void updateItem(ItemDTO I) throws SQLException, ClassNotFoundException {
        ...
        pstm.setBigDecimal(2,I.getUnitPrice());
        pstm.setInt(3,I.getQtyOnHand());
        pstm.setString(4, I.getDescription());
        pstm.executeUpdate();
    }
